...
| 5.1.3 |   | ??? |    |  -  |  H  |
| 6 |  어플 설정  |    |     |    -    |        |
| 6.1   |  | 알림, 진동 온오프 등 어플에서 제공하는 기능에 대한 설정을 한다.  |  | - |  |
| 6.1.1 |   |   | 설정 버튼을 눌러 어플 설정을 할 수 있다.   |  -  |  H  |
| 6.1.2 |   |   | 사용자가 설정을 바꾸면 바로 반영된다.   |  -  |  H  |
| 6.1.3 |   |   | 설정에서 알림, 진동 on/off를 할 수 있다.   |  -  |  H  |
| 6.1.4 |   |   | 설정에서 테마를 변경할 수 있다.   |  -  |  H  |
| 6.1.5 |   |   | 설정에서 버전 정보를 알 수 있다.   |  -  |  H  |